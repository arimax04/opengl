...
void draw_cube(){
  ...
  GLdouble pointB[] = {0, 1.0,0};
  GLdouble pointC[] = {0, 0, 1};
  GLdouble pointD[] = {1, 1, 0};
  GLdouble pointE[] = {0.0, 1.0, 1.0};
  GLdouble pointF[] = {1, 0, 1};
